defmodule TestAuthWeb.UserAuthTest do
  use TestAuthWeb.ConnCase, async: true

  alias TestAuth.Accounts
  alias TestAuthWeb.UserAuth
  import TestAuth.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TestAuthWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TestAuthWeb.Endpoint.subscribe(live_socket_id)
